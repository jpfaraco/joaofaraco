...
DataConverter.prototype.create = function(w,h) {
  ...
  this.inputHeader = $('<div id="input"><div class="groupHeader" id="inputHeader"><p class="groupHeadline">Paste your data here.</p></div>');
  this.inputTextArea = $('<textarea class="textInputs" id="dataInput"></textarea></div>');
  this.outputHeader = $('<div id="result"><div class="groupHeader" id="inputHeader"><p class="groupHeadline resultHeadline">Copy the generated XML, paste it in a text editor and save it as <strong>.XML</strong>.</p></div>');
